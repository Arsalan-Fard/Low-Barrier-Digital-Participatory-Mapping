...
export default class App extends React.Component<any, AppState> {
  ...
  onMapReady = (map: Map | null) => {
    if (this.maplibreMap !== map) {
  ...
  mapRenderer() {
    ...
    const mapProps = {
      ...
      replaceAccessTokens: this.replaceAccessTokens,
  ...
  render() {
    ...
    const displayedMapStyle = this.state.dirtyMapStyle || this.state.mapStyle;

    const toolbar = <AppToolbar
      map={this.maplibreMap}
      renderer={this._getRenderer()}
      mapState={this.state.mapState}
      mapStyle={displayedMapStyle}
      replaceAccessTokens={this.replaceAccessTokens}
      inspectModeEnabled={this.state.mapState === "inspect"}
